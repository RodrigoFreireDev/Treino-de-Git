...
2.  Clique em **Draft a new release** (Rascunhar um novo release).
3.  **Escolha ou crie uma tag**: No campo **Choose a tag**, você pode selecionar uma tag existente ou digitar uma nova para criar.
