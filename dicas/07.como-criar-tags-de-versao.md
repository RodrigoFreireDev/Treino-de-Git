...
O usuário está pedindo um documento em formato Markdown (`.md`) que explique o que é **Controle de Versões** utilizando como base o **Versionamento Semântico 2.0.0 (SemVer)** e forneça dicas e melhores práticas para seu uso.

A resposta deve ser estruturada logicamente com títulos em Markdown e abordar:
...
Vou criar um documento Markdown completo e bem estruturado.\# O que é Versionamento Semântico (SemVer 2.0.0)?
